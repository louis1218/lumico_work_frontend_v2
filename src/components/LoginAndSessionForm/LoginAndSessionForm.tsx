...
export default function LoginAndSessionForm({ onComplete }: LoginAndSessionFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const sessionObject: Session = {
        site, date, name, session_id, login_time, username, role, expiresAt,
      }

      localStorage.setItem('loginUser', JSON.stringify({ username, first_name, last_name, role, expiresAt }))
